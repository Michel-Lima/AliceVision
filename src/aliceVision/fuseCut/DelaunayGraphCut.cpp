...
mesh::Mesh* DelaunayGraphCut::createTetrahedralMesh(bool filter, const std::function<float(const GC_cellInfo&)> getScore, const float& downscaleFactor) const
{
...
{
    std::unique_ptr<mesh::Mesh> mesh(createTetrahedralMesh(false));
    std::unique_ptr<mesh::Mesh> meshf(createTetrahedralMesh(true));
...
{
    std::unique_ptr<mesh::Mesh> meshEmptiness(createTetrahedralMesh(false, [](const GC_cellInfo& c) { return c.emptinessScore; }, 0.9999f));
    std::unique_ptr<mesh::Mesh> meshFullness(createTetrahedralMesh(false, [](const GC_cellInfo& c) { return c.fullnessScore; }, 0.9999f));
    std::unique_ptr<mesh::Mesh> meshSWeight(createTetrahedralMesh(false, [](const GC_cellInfo& c) { return c.cellSWeight; }, 0.9999f));
    std::unique_ptr<mesh::Mesh> meshTWeight(createTetrahedralMesh(false, [](const GC_cellInfo& c) { return c.cellTWeight; }, 0.9999f));
    std::unique_ptr<mesh::Mesh> meshOn(createTetrahedralMesh(false, [](const GC_cellInfo& c) { return c.on; }, 0.9999f));
